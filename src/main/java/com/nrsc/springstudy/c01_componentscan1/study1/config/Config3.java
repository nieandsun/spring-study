...
import com.nrsc.springstudy.c01_componentscan1.study1.config3_test.OrderRepository3;
...
@Configuration
//扫描整个config3_test目录
//@ComponentScan(value = "com.nrsc.springstudy.c01_componentscan1.study1.config3_test")
